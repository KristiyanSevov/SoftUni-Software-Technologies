    ...
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if($operator == "/" && $rightOperand == 0) {
                return $this->render('calculator/index.html.twig', ['dividing_by_zero' => true, 'form' => $form->createView()]);
            }
            $result = 0;
            switch ($operator) {
                case '+':
        ...
        return $this->render('calculator/index.html.twig', ['dividing_by_zero' => false, 'form' => $form->createView()]);
    }
}
